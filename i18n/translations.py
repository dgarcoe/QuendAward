...
TRANSLATIONS = {
    'en': {
        ...
        'qso_delete_confirm': '⚠️ {count} QSO(s) selected for deletion.',
        'qso_delete_btn': 'Delete selected QSOs',
    ...
    'es': {
        ...
        'qso_delete_confirm': '⚠️ {count} QSO(s) seleccionados para eliminar.',
        'qso_delete_btn': 'Eliminar QSOs seleccionados',
