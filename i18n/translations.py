...
TRANSLATIONS = {
    'en': {
        ...
        'qso_stats_title': 'Statistics',
        'qso_total': 'Total QSOs',
        'qso_today': 'Today',
        'qso_unique_calls': 'Unique Calls',
        'qso_active_operators': 'Operators',
        'qso_by_band': 'By Band',
        'qso_by_mode': 'By Mode',
        'qso_by_operator': 'By Operator',
        'qso_upload_title': 'Upload ADIF',
        'qso_upload_info': 'Upload an ADIF file (.adi/.adif) to import QSOs for this callsign.',
        'qso_upload_button': 'Import QSOs',
        'qso_upload_success': 'Import successful',
        'qso_upload_error': 'Import error',
        'qso_upload_preview': 'Preview: {count} QSOs found',
        'qso_upload_warnings': 'Warnings ({count})',
        'qso_upload_no_records': 'No valid QSO records found in the file.',
        'qso_upload_select_award': 'Please select a special callsign first.',
        'qso_consolidated_log': 'Consolidated Log',
        'qso_filter_band': 'Band',
        'qso_filter_mode': 'Mode',
        'qso_filter_operator': 'Operator',
        'qso_filter_all': 'All',
        'qso_col_date': 'Date',
        'qso_col_time': 'Time',
        'qso_col_operator': 'Operator',
        'qso_col_call': 'Callsign',
        'qso_col_band': 'Band',
        'qso_col_mode': 'Mode',
        'qso_col_rst_sent': 'RST Sent',
        'qso_col_rst_rcvd': 'RST Rcvd',
        'qso_col_freq': 'Freq (MHz)',
        'qso_col_name': 'Name',
        'qso_col_comment': 'Comment',
        'qso_log_desktop_only': 'The consolidated log is available on the desktop version.',
        'qso_export_actions': 'Export & Actions',
        'qso_export_my_adif': 'Export My ADIF',
        'qso_export_all_adif': 'Export All ADIF',
        'qso_delete_my_qsos': 'Delete My QSOs',
        'qso_delete_my_qsos_confirm': 'Are you sure you want to delete all your QSOs for this callsign?',
        'qso_admin_edit': 'Edit QSO',
        'qso_admin_delete': 'Delete QSO',
        'qso_admin_delete_confirm': 'Are you sure you want to delete this QSO?',
        'qso_admin_delete_operator': 'Delete All QSOs for Operator',
        'qso_admin_delete_operator_confirm': 'Are you sure you want to delete all QSOs for {callsign}?',
        'qso_edit_success': 'QSO updated successfully',
        'qso_delete_success': 'QSO deleted successfully',
        'qso_no_qsos': 'No QSOs recorded yet. Upload an ADIF file to get started.',
        'qso_click_to_edit': 'Click a row to edit or delete',
        'qso_page_info': 'Showing {start}-{end} of {total}',
        'qso_per_page': 'Per page',
        'qso_save': 'Save',
        'qso_cancel': 'Cancel',
        'feature_qso_log': 'QSO Log',
    },
    'es': {
        # General
        ...
        # QSO Log
        'tab_qso_log': 'Registro QSO',
        'qso_log_title': 'Registro QSO',
        'qso_stats_title': 'Estadísticas',
        'qso_total': 'Total QSOs',
        'qso_today': 'Hoy',
        'qso_unique_calls': 'Indicativos Únicos',
        'qso_active_operators': 'Operadores',
        'qso_by_band': 'Por Banda',
        'qso_by_mode': 'Por Modo',
        'qso_by_operator': 'Por Operador',
        'qso_upload_title': 'Subir ADIF',
        'qso_upload_info': 'Sube un archivo ADIF (.adi/.adif) para importar QSOs de este indicativo.',
        'qso_upload_button': 'Importar QSOs',
        'qso_upload_success': 'Importación exitosa',
        'qso_upload_error': 'Error de importación',
        'qso_upload_preview': 'Vista previa: {count} QSOs encontrados',
        'qso_upload_warnings': 'Advertencias ({count})',
        'qso_upload_no_records': 'No se encontraron registros QSO válidos en el archivo.',
        'qso_upload_select_award': 'Por favor seleccione un indicativo especial primero.',
        'qso_consolidated_log': 'Registro Consolidado',
        'qso_filter_band': 'Banda',
        'qso_filter_mode': 'Modo',
        'qso_filter_operator': 'Operador',
        'qso_filter_all': 'Todos',
        'qso_col_date': 'Fecha',
        'qso_col_time': 'Hora',
        'qso_col_operator': 'Operador',
        'qso_col_call': 'Indicativo',
        'qso_col_band': 'Banda',
        'qso_col_mode': 'Modo',
        'qso_col_rst_sent': 'RST Env',
        'qso_col_rst_rcvd': 'RST Rec',
        'qso_col_freq': 'Freq (MHz)',
        'qso_col_name': 'Nombre',
        'qso_col_comment': 'Comentario',
        'qso_log_desktop_only': 'El log consolidado está disponible en la versión de escritorio.',
        'qso_export_actions': 'Exportar y Acciones',
        'qso_export_my_adif': 'Exportar Mi ADIF',
        'qso_export_all_adif': 'Exportar Todo ADIF',
        'qso_delete_my_qsos': 'Borrar Mis QSOs',
        'qso_delete_my_qsos_confirm': '¿Estás seguro de que quieres borrar todos tus QSOs de este indicativo?',
        'qso_admin_edit': 'Editar QSO',
        'qso_admin_delete': 'Eliminar QSO',
        'qso_admin_delete_confirm': '¿Estás seguro de que quieres eliminar este QSO?',
        'qso_admin_delete_operator': 'Eliminar Todos los QSOs del Operador',
        'qso_admin_delete_operator_confirm': '¿Estás seguro de que quieres eliminar todos los QSOs de {callsign}?',
        'qso_edit_success': 'QSO actualizado correctamente',
        'qso_delete_success': 'QSO eliminado correctamente',
        'qso_no_qsos': 'Aún no hay QSOs registrados. Sube un archivo ADIF para empezar.',
        'qso_click_to_edit': 'Haz clic en una fila para editar o eliminar',
        'qso_page_info': 'Mostrando {start}-{end} de {total}',
        'qso_per_page': 'Por página',
        'qso_save': 'Guardar',
        'qso_cancel': 'Cancelar',
        'feature_qso_log': 'Registro QSO',
    },
    'gl': {
        # General
        ...
        # QSO Log
        'tab_qso_log': 'Rexistro QSO',
        'qso_log_title': 'Rexistro QSO',
        'qso_stats_title': 'Estatísticas',
        'qso_total': 'Total QSOs',
        'qso_today': 'Hoxe',
        'qso_unique_calls': 'Indicativos Únicos',
        'qso_active_operators': 'Operadores',
        ...
        'qso_by_operator': 'Por Operador',
        'qso_upload_title': 'Subir ADIF',
        'qso_upload_info': 'Sube un ficheiro ADIF (.adi/.adif) para importar QSOs deste indicativo.',
        'qso_upload_button': 'Importar QSOs',
        'qso_upload_success': 'Importación exitosa',
        'qso_upload_error': 'Erro de importación',
        'qso_upload_preview': 'Vista previa: {count} QSOs atopados',
        'qso_upload_warnings': 'Avisos ({count})',
        'qso_upload_no_records': 'Non se atoparon rexistros QSO válidos no ficheiro.',
        'qso_upload_select_award': 'Por favor seleccione un indicativo especial primeiro.',
        'qso_consolidated_log': 'Rexistro Consolidado',
        'qso_filter_band': 'Banda',
        'qso_filter_mode': 'Modo',
        'qso_filter_operator': 'Operador',
        'qso_filter_all': 'Todos',
        ...
        'qso_col_name': 'Nome',
        'qso_col_comment': 'Comentario',
        'qso_log_desktop_only': 'O log consolidado está dispoñible na versión de escritorio.',
        'qso_export_actions': 'Exportar e Accións',
        'qso_export_my_adif': 'Exportar O Meu ADIF',
        'qso_export_all_adif': 'Exportar Todo ADIF',
        'qso_delete_my_qsos': 'Borrar Os Meus QSOs',
        'qso_delete_my_qsos_confirm': 'Estás seguro de que queres borrar todos os teus QSOs deste indicativo?',
        'qso_admin_edit': 'Editar QSO',
        'qso_admin_delete': 'Eliminar QSO',
        'qso_admin_delete_confirm': 'Estás seguro de que queres eliminar este QSO?',
        'qso_admin_delete_operator': 'Eliminar Todos os QSOs do Operador',
        'qso_admin_delete_operator_confirm': 'Estás seguro de que queres eliminar todos os QSOs de {callsign}?',
        'qso_edit_success': 'QSO actualizado correctamente',
        'qso_delete_success': 'QSO eliminado correctamente',
        'qso_no_qsos': 'Aínda non hai QSOs rexistrados. Sube un ficheiro ADIF para comezar.',
        'qso_click_to_edit': 'Fai clic nunha fila para editar ou eliminar',
        'qso_page_info': 'Mostrando {start}-{end} de {total}',
        'qso_per_page': 'Por páxina',
        'qso_save': 'Gardar',
        'qso_cancel': 'Cancelar',
        'feature_qso_log': 'Rexistro QSO',
    }
}
