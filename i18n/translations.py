...
TRANSLATIONS = {
    'en': {
        ...
        'status_unavailable': 'Not usable on this band',
        'error_band_mode_illegal': '{mode} is not used on the {band} band',
        'error_band_mode_illegal_short': 'is not used on the',
        ...
        'restricted_access_label': 'Restricted access (only members can block)',
        'restricted_access_help': 'When enabled, only approved members, managers, and admins can block bands on this award.',
        'band_mode_config_title': 'Allowed bands & modes',
        'band_mode_config_help': 'Uncheck bands or modes you do not want to use for this callsign. Only checked combinations will appear on the dashboard and be available for blocking.',
        'band_mode_toggle_modes': 'Toggle entire mode:',
        'band_mode_reset_defaults': 'Reset to defaults',
        'managers_label': 'Managers',
        'no_managers': 'No managers yet.',
        ...
        'added_by': 'added by',
        'all_operators_are_members': 'All operators are already members.',
        'active_blocks_label': 'Active blocks',
        'no_active_blocks': 'No active blocks.',
        'unblock_label': 'Unblock',
        'not_a_member_error': 'You are not a member of this award. Ask a manager to add you.',
        # QSO Log
        'tab_qso_log': 'QSO Log',
        'qso_log_title': 'QSO Log',
        'qso_upload_heading': 'Upload ADIF log',
        'qso_upload_on_behalf': 'Upload on behalf of',
        'qso_upload_help': 'Upload an ADIF file exported from your logger (N1MM, Log4OM, etc.). Duplicates are skipped automatically. Max 10 MB per upload.',
        'qso_upload_label': 'ADIF file',
        'qso_upload_button': 'Ingest log',
        'qso_upload_processing': 'Processing {size_kb} KB…',
        'qso_upload_timeout': 'Still processing in the background — refresh in a moment.',
        'qso_upload_failed': 'Ingest failed. Please check the file and try again.',
        'qso_upload_too_large': 'File too large (max 10 MB).',
        'qso_upload_result': '✅ {inserted} new QSOs, {duplicates} duplicates, {errors} errors',
        'qso_total': 'Total QSOs',
        'qso_unique_calls': 'Unique Calls',
        'qso_top_band': 'Top Band',
        'qso_by_band': 'By Band',
        'qso_by_mode': 'By Mode',
        'qso_recent_heading': 'Log',
        'qso_no_qsos': 'No QSOs uploaded yet.',
        'qso_filter_band': 'Band',
        'qso_filter_mode': 'Mode',
        'qso_all': 'All',
        'qso_page': 'Page',
        'qso_page_info': 'Showing {shown} of {total} QSOs — page {page} of {pages}',
        'qso_col_date': 'Date',
        'qso_col_time': 'UTC',
        'qso_col_call': 'Call',
        'qso_col_band': 'Band',
        ...
        'qso_col_rst_r': 'R',
        'qso_col_op': 'Op',
        'qso_export_adif': 'Export ADIF',
        'qso_admin_delete_heading': 'Delete operator QSOs',
        'qso_admin_select_op': 'Select operator',
        'qso_admin_delete_btn': 'Delete all QSOs from this operator',
        'qso_admin_delete_warn': '⚠️ This will permanently delete all {count} QSOs from {callsign}. Are you sure?',
        'qso_deleted_ok': '✅ {count} QSO(s) deleted.',
        'qso_upload_history': 'Upload history',
        'qso_no_batches': 'No uploads yet.',
        'qso_batch_inserted': 'Inserted',
        'qso_batch_duplicates': 'Duplicates',
        'qso_batch_errors': 'Errors',
        'qso_batch_undo': 'Undo this upload',
        'qso_batch_undone': 'Removed {n} QSOs from this batch',
        'qso_batch_undo_failed': 'Could not remove this batch',
        ...
        'qso_chart_dxcc': 'DXCC',
        'qso_dxcc_unique': 'DXCC entities: {count}',
        ...
        # Activation stats
        'act_stats_title': 'Activation Statistics',
        'act_total_activations': 'Activations',
        'act_total_time': 'Total time',
        'act_avg_duration': 'Avg duration',
        'act_operators_count': 'Operators',
        'act_chart_timeline': 'Activity over time',
        'act_chart_hours': 'Hours',
        'act_chart_activations': 'Activations',
        'act_chart_operator_title': 'Time per operator',
        'act_chart_band_title': 'Time per band',
        'act_chart_mode_title': 'Time per mode',
        'act_chart_hourly_title': 'Activations by hour (UTC)',
        'act_subtab_band_mode': 'Band / Mode',
        'act_recent_title': 'Recent activations',
        'export_html_btn': 'Export HTML Report',
        'export_generated': 'Report generated',
        'act_col_start': 'Start',
        'act_col_end': 'End',
    ...
    'es': {
        ...
        'status_unavailable': 'No utilizable en esta banda',
        'error_band_mode_illegal': '{mode} no se usa en la banda {band}',
        'error_band_mode_illegal_short': 'no se usa en la',
        ...
        'restricted_access_label': 'Acceso restringido (solo miembros pueden bloquear)',
        'restricted_access_help': 'Cuando está activo, solo miembros aprobados, gestores y administradores pueden bloquear bandas en este indicativo.',
        'band_mode_config_title': 'Bandas y modos permitidos',
        'band_mode_config_help': 'Desmarca las bandas o modos que no quieras usar para este indicativo. Solo las combinaciones marcadas aparecerán en el panel y estarán disponibles para bloquear.',
        'band_mode_toggle_modes': 'Activar/desactivar modo completo:',
        'band_mode_reset_defaults': 'Restablecer valores por defecto',
        'managers_label': 'Gestores',
        'no_managers': 'Aún no hay gestores.',
        'add_manager': 'Añadir gestor',
        'remove_manager': 'Quitar gestor',
        ...
        'all_operators_are_members': 'Todos los operadores ya son miembros.',
        'active_blocks_label': 'Bloqueos activos',
        'no_active_blocks': 'Sin bloqueos activos.',
        'unblock_label': 'Desbloquear',
        'not_a_member_error': 'No eres miembro de este indicativo. Pide a un gestor que te añada.',
        # QSO Log
        'tab_qso_log': 'Libro de QSOs',
        'qso_log_title': 'Libro de QSOs',
        'qso_upload_heading': 'Subir log ADIF',
        'qso_upload_on_behalf': 'Subir en nombre de',
        'qso_upload_help': 'Sube un archivo ADIF exportado desde tu logger (N1MM, Log4OM, etc.). Los duplicados se omiten automáticamente. Máximo 10 MB por subida.',
        'qso_upload_label': 'Archivo ADIF',
        'qso_upload_button': 'Importar log',
        'qso_upload_processing': 'Procesando {size_kb} KB…',
        'qso_upload_timeout': 'Seguimos procesando en segundo plano — recarga en un momento.',
        'qso_upload_failed': 'La importación falló. Por favor revisa el archivo e inténtalo de nuevo.',
        'qso_upload_too_large': 'Archivo demasiado grande (máx 10 MB).',
        'qso_upload_result': '✅ {inserted} QSOs nuevos, {duplicates} duplicados, {errors} errores',
        'qso_total': 'QSOs totales',
        'qso_unique_calls': 'Indicativos únicos',
        'qso_top_band': 'Banda principal',
        'qso_by_band': 'Por banda',
        'qso_by_mode': 'Por modo',
        'qso_recent_heading': 'Log',
        'qso_no_qsos': 'Aún no hay QSOs subidos.',
        'qso_filter_band': 'Banda',
        'qso_filter_mode': 'Modo',
        'qso_all': 'Todos',
        'qso_page': 'Página',
        'qso_page_info': 'Mostrando {shown} de {total} QSOs — página {page} de {pages}',
        'qso_col_date': 'Fecha',
        'qso_col_time': 'UTC',
        'qso_col_call': 'Indicativo',
        'qso_col_band': 'Banda',
        'qso_col_mode': 'Modo',
        'qso_col_rst_s': 'E',
        'qso_col_rst_r': 'R',
        'qso_col_op': 'Op',
        'qso_export_adif': 'Exportar ADIF',
        'qso_admin_delete_heading': 'Eliminar QSOs de operador',
        'qso_admin_select_op': 'Seleccionar operador',
        'qso_admin_delete_btn': 'Eliminar todos los QSOs de este operador',
        'qso_admin_delete_warn': '⚠️ Esto eliminará permanentemente los {count} QSOs de {callsign}. ¿Estás seguro?',
        'qso_deleted_ok': '✅ {count} QSO(s) eliminados.',
        'qso_upload_history': 'Historial de subidas',
        'qso_no_batches': 'Aún no hay subidas.',
        'qso_batch_inserted': 'Insertados',
        'qso_batch_duplicates': 'Duplicados',
        'qso_batch_errors': 'Errores',
        'qso_batch_undo': 'Deshacer esta subida',
        'qso_batch_undone': 'Se eliminaron {n} QSOs de este lote',
        'qso_batch_undo_failed': 'No se pudo eliminar este lote',
        ...
        'qso_chart_dxcc': 'DXCC',
        'qso_dxcc_unique': 'Entidades DXCC: {count}',
        ...
        # Activation stats
        'act_stats_title': 'Estadísticas de Activación',
        'act_total_activations': 'Activaciones',
        'act_total_time': 'Tiempo total',
        'act_avg_duration': 'Duración media',
        'act_operators_count': 'Operadores',
        'act_chart_timeline': 'Actividad a lo largo del tiempo',
        'act_chart_hours': 'Horas',
        'act_chart_activations': 'Activaciones',
        'act_chart_operator_title': 'Tiempo por operador',
        'act_chart_band_title': 'Tiempo por banda',
        'act_chart_mode_title': 'Tiempo por modo',
        'act_chart_hourly_title': 'Activaciones por hora (UTC)',
        'act_subtab_band_mode': 'Banda / Modo',
        'act_recent_title': 'Activaciones recientes',
        'export_html_btn': 'Exportar informe HTML',
        'export_generated': 'Informe generado',
    ...
    'gl': {
        ...
        'status_unavailable': 'Non utilizable nesta banda',
        'error_band_mode_illegal': '{mode} non se usa na banda {band}',
        'error_band_mode_illegal_short': 'non se usa na',
        ...
        'access_control': 'Control de acceso',
        'restricted_access_label': 'Acceso restrinxido (só membros poden bloquear)',
        'restricted_access_help': 'Cando está activo, só membros aprobados, xestores e administradores poden bloquear bandas neste indicativo.',
        'band_mode_config_title': 'Bandas e modos permitidos',
        'band_mode_config_help': 'Desmarca as bandas ou modos que non queiras usar para este indicativo. Só as combinacións marcadas aparecerán no panel e estarán dispoñibles para bloquear.',
        'band_mode_toggle_modes': 'Activar/desactivar modo completo:',
        'band_mode_reset_defaults': 'Restablecer valores por defecto',
        'managers_label': 'Xestores',
        'no_managers': 'Aínda non hai xestores.',
        'add_manager': 'Engadir xestor',
        'remove_manager': 'Quitar xestor',
        'members_label': 'Membros',
        'no_members': 'Aínda non hai membros.',
        'add_member': 'Engadir membro',
        'remove_member': 'Quitar membro',
        'added_by': 'engadido por',
        'all_operators_are_members': 'Todos os operadores xa son membros.',
        'active_blocks_label': 'Bloqueos activos',
        'no_active_blocks': 'Sen bloqueos activos.',
        'unblock_label': 'Desbloquear',
        'not_a_member_error': 'Non es membro deste indicativo. Pídelle a un xestor que te engada.',
        # QSO Log
        'tab_qso_log': 'Libro de QSOs',
        'qso_log_title': 'Libro de QSOs',
        'qso_upload_heading': 'Subir log ADIF',
        'qso_upload_on_behalf': 'Subir en nome de',
        'qso_upload_help': 'Sube un ficheiro ADIF exportado desde o teu logger (N1MM, Log4OM, etc.). Os duplicados omítense automaticamente. Máximo 10 MB por subida.',
        'qso_upload_label': 'Ficheiro ADIF',
        'qso_upload_button': 'Importar log',
        'qso_upload_processing': 'Procesando {size_kb} KB…',
        'qso_upload_timeout': 'Seguimos procesando en segundo plano — recarga nun momento.',
        'qso_upload_failed': 'A importación fallou. Revisa o ficheiro e téntao de novo.',
        'qso_upload_too_large': 'Ficheiro demasiado grande (máx 10 MB).',
        'qso_upload_result': '✅ {inserted} QSOs novos, {duplicates} duplicados, {errors} erros',
        'qso_total': 'QSOs totais',
        'qso_unique_calls': 'Indicativos únicos',
        'qso_top_band': 'Banda principal',
        'qso_by_band': 'Por banda',
        'qso_by_mode': 'Por modo',
        'qso_recent_heading': 'Log',
        'qso_no_qsos': 'Aínda non hai QSOs subidos.',
        'qso_filter_band': 'Banda',
        'qso_filter_mode': 'Modo',
        'qso_all': 'Todos',
        'qso_page': 'Páxina',
        'qso_page_info': 'Amosando {shown} de {total} QSOs — páxina {page} de {pages}',
        'qso_col_date': 'Data',
        'qso_col_time': 'UTC',
        'qso_col_call': 'Indicativo',
        'qso_col_band': 'Banda',
        ...
        'qso_admin_delete_heading': 'Eliminar QSOs de operador',
        'qso_admin_select_op': 'Seleccionar operador',
        'qso_admin_delete_btn': 'Eliminar todos os QSOs deste operador',
        'qso_admin_delete_warn': '⚠️ Isto eliminará permanentemente os {count} QSOs de {callsign}. Estás seguro?',
        'qso_deleted_ok': '✅ {count} QSO(s) eliminados.',
        'qso_upload_history': 'Historial de subidas',
        'qso_no_batches': 'Aínda non hai subidas.',
        'qso_batch_inserted': 'Insertados',
        'qso_batch_duplicates': 'Duplicados',
        'qso_batch_errors': 'Erros',
        'qso_batch_undo': 'Desfacer esta subida',
        'qso_batch_undone': 'Elimináronse {n} QSOs deste lote',
        'qso_batch_undo_failed': 'Non se puido eliminar este lote',
        'qso_scope_label': 'Alcance',
        ...
        'qso_insight_active_days': 'Días activos',
        # Activation stats
        'act_stats_title': 'Estatísticas de Activación',
        'act_total_activations': 'Activacións',
        'act_total_time': 'Tempo total',
        'act_avg_duration': 'Duración media',
        'act_operators_count': 'Operadores',
        'act_chart_timeline': 'Actividade ao longo do tempo',
        'act_chart_hours': 'Horas',
        'act_chart_activations': 'Activacións',
        'act_chart_operator_title': 'Tempo por operador',
        'act_chart_band_title': 'Tempo por banda',
        'act_chart_mode_title': 'Tempo por modo',
        'act_chart_hourly_title': 'Activacións por hora (UTC)',
        'act_subtab_band_mode': 'Banda / Modo',
        'act_recent_title': 'Activacións recentes',
        'export_html_btn': 'Exportar informe HTML',
        'export_generated': 'Informe xerado',
        'act_col_start': 'Inicio',
        'act_col_end': 'Fin',
        'act_col_duration': 'Duración',
